%  [w, err, hump] = expv_mod( t, A, v, tol, m )
%  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%
%  Modified version by A. Klein, the line containing s = norm(p) has been
%  replaced by the direct and faster version s = sqrt(p'*p)
%
%  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
function [w, err, hump] = expv_mod( t, A, v, tol, m )
